...
class Infolio_Walker_Nav extends Walker_Nav_Menu{
    ...
    function start_lvl(&$output, $depth = 0, $args = NULL){ //<ul>
        ...
        $output .= "\n$indent<ul class=\"infolio-nav-item sub-menu depth_$depth\">\n";
    }
    ...
    function get_megamenu( $id ) {
        ...
        $style = $css = '';
            ...
            return $css . '<div class="infolio-mega-nav-item"><div class="infolio-mega-menu-wrap megamenu-container container" '. $style . '>' . \Elementor\Plugin::instance()->frontend->get_builder_content_for_display( $id )  . '</div></div>';
    }
