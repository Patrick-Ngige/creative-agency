 ...
 * @since 1.0.0
 */
class Infolio_Portfolio_Carsouel extends Widget_Base
{
    ...
    {
        return 'infolio-portfolio-carsouel';
    }
    ...
    {
        return __('Infolio Portfolio Carsouel', 'infolio_plg');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            'clip_path',
            [
                'label' => __('Clip Path', 'infolio_plg'),
                'description' => __('Slides starting sliders from the beginning of the section.', 'infolio_plg'),
...
//        section heading
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .infolio-portfolio-carsouel .sec-head .sub-title',
            ]
        );
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                ...
                'selector' => '{{WRAPPER}} .infolio-portfolio-carsouel .sec-head h2',
            ]
        );
        $this->end_controls_section();
        $this->start_controls_section(
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'content_border',
                'label' => esc_html__( 'Content Border', 'infolio_plg' ),
                'selector' => '{{WRAPPER}} .infolio-portfolio-carsouel .item .cont',
                'separator' => 'after',
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .infolio-portfolio-carsouel .item .cont h5' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .infolio-portfolio-carsouel .item .cont h5',
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .infolio-portfolio-carsouel .item .cont h5' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .infolio-portfolio-carsouel .item .cont p',
            ]
        );
        $this->add_responsive_control(
            'category_margin',
            [
                ...
                'size_units' => ['px', '%', 'em' , 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .infolio-portfolio-carsouel .item .cont p' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            'width',
            [
                'label' => esc_html__( 'Read More Icon Width', 'infolio_plg' ),
                ...
                'selectors' => [
                    '{{WRAPPER}} .infolio-portfolio-carsouel .item .cont .rmore .icon-img' => 'width: {{SIZE}}{{UNIT}};',
                ],
                'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .infolio-portfolio-carsouel .swiper-slide .item .img' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .infolio-portfolio-carsouel .swiper-slide .item .img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
    ...
    protected function render()
    {
        ...
        <div class="infolio-portfolio-carsouel <?php if ($settings['clip_path']=='yes')echo 'clip-path'?>">
        ...
        <?php endif;?>
            <div class="<?= ($settings['center']=='yes') ? 'infolio-work-swiper-center' :'infolio-work-swiper-auto'?> infolio-portfolio-carsouel-init" data-carousel="swiper" data-items="auto" <?php if ($settings['center']=='yes') : ?> data-center="center" <?php endif;?> <?php if ($settings['loop']=='yes') : ?> data-loop="true" <?php endif;?> data-space="<?= esc_attr($settings['space']); ?>">
                <div id="content-carousel-container-unq-work-<?= $slider_id ?>" class="swiper-container"
                     data-swiper="container">
                    <div class="swiper-wrapper <?php if ($settings['different_width']=='yes')echo 'different-width'?>">
