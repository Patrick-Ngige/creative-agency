...
class Importer {
     ...
     * @return array
     */
    public function tcg_custom_upload_mimes( array $tcg_existing_mimes = array() ): array {
        $tcg_existing_mimes['svg']   = 'image/svg+xml';

        return $tcg_existing_mimes;
    }
	...
	public function import_content( $import_file_path ) {
        ...
        add_filter( 'upload_mimes', array( $this, 'tcg_custom_upload_mimes' ) );
