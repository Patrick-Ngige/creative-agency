(function ($) {
    ...
    $(document).ready(function () {
        let bgColor = $("body").css('background-color') ? $("body").css('background-color') : $("body").css('background');
        let brightness = lightOrDark(bgColor);
        console.log(brightness)
        
        const canvas = document.getElementsByTagName("canvas")[0];
        canvas.width = canvas.clientWidth;
        canvas.height = canvas.clientHeight;
        let smokeType = $(canvas).data('smoke-type')
        let canvasBackColor;
        if(brightness == 'dark' && smokeType == 'auto'){
            canvasBackColor = {
                r: 2,
                g: 3,
                b: 15
            }
        } if(brightness == 'light' && smokeType == 'auto'){
            canvasBackColor = {
                r: 255,
                g: 255,
                b: 255
