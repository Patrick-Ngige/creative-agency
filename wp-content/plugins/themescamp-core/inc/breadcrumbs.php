...
if( ! function_exists( 'themescamp_breadcrumbs' )){

	function themescamp_breadcrumbs(){
			


		# breadcrumbs ----------

		$home_text  = esc_html__( 'Home', 'themescamp' );
		...
		if ( ! is_home() && ! is_front_page() || is_paged() ){
			...
			elseif ( is_singular() ){			
				...
				if ( get_post_type() == 'post' ){
					...
					$category = themescamp_get_primary_category_id();
					$category = get_category( $category );
