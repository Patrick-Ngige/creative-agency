...
<?php $tcg_related_posts  = themescamp_settings( 'Single_related_posts', 3 );  ?>
	...
	<div class="related-bottom">
		<div class="container clearfix">
			<div class="row">
				<div class="col">
					<!--RELATED POST-->
					<div class="tcg-related-slider">
						<section class="popular-posts related Posts section-padding bg-gray5">
								<h5 class="fw-bold text-uppercase mb-30"><?php echo esc_html__('Related Posts','themescamp-core'); ?></h5>
													...
													<div class="card border-0 bg-transparent rounded-0 p-0  d-block">
														...
														<div class="card-body px-0">
															<small class="d-block date mt-10 fs-10px">
																...
																<span class="op-8"><?php echo esc_html(__('Posted on ', 'themescamp-core').themescamp_time_ago()); ?></span>
															</small>
															...
															<div class="d-flex small mt-20 align-items-center justify-content-between op-9">
																...
																<div class="r-side mt-1">
																	...
																	<span><?php echo esc_html(themescamp_get_post_view()); ?></span>
																</div>
															</div>
														</div>
													</div>
