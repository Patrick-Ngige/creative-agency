 ...
 * @since 4.0.0
 */
class TCG_Post_Title extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'TC Post Title', 'themescamp-core' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_title',
			[
				'label' => esc_html__( 'Title', 'themescamp-core' ),
			]
		);
		...
		$this->add_control(
			'view',
			[
				'label' => esc_html__( 'View', 'themescamp-core' ),
	...
	protected function render() {
        ...
        if( !\Elementor\Plugin::$instance->editor->is_edit_mode() ) {
            ...
            $title = __( 'This is a dummy title.', 'themescamp-core' );
        }
...
\Elementor\Plugin::instance()->widgets_manager->register(new TCG_Post_Title());
