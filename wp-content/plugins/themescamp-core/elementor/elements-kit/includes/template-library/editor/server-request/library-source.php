...
class Library_Source extends Source_Base {
	 ...
	 */
	const LIBRARY_CACHE_KEY = 'ElementKit_library_cache';

	public function get_id() {
		return 'tc-element-kit-library';
	}

	public function get_title() {
		return __( 'ElementKit Library', 'themescamp-core' );
	}

	public function register_data() {}

	public function save_item( $template_data ) {
		return new \WP_Error( 'invalid_request', 'Cannot save template to a ElementKit library' );
	}

	public function update_item( $new_data ) {
		return new \WP_Error( 'invalid_request', 'Cannot update template to a ElementKit library' );
	}

	public function delete_template( $template_id ) {
		return new \WP_Error( 'invalid_request', 'Cannot delete template from a ElementKit library' );
	}

	public function export_template( $template_id ) {
		return new \WP_Error( 'invalid_request', 'Cannot export template from a ElementKit library' );
	}
	...
	public function get_data( array $args, $context = 'display' ) {
		...
		if ( empty( $data ) || empty( $data['content'] ) ) {
			throw new \Exception( __( 'Template does not have any content', 'themescamp-core' ) );
		}
