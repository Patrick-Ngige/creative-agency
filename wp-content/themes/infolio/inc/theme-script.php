...
function infolio_theme_scripts() {
	...
	wp_enqueue_script( 'infolio-totop', get_template_directory_uri() . '/assets/js/totop.js',array(),'', 'in_footer');
	...
	wp_enqueue_script( 'infolio-scripts', get_template_directory_uri() . '/assets/js/scripts.js',array( 'jquery' ),'', true);
}     